...
BASIC = [
    ...
    ('4-Layer 분류 *',   '[ISSU 분류] 아키텍처상 어느 층인가 — 모르면 비워두세요',                                        30, options('sol-layer')),
    ('제공 형태',        '예) SaaS/API · SW(On-prem) · Hybrid',                           18, None),
    ('MZC 시너지',       '[ISSU 분류] MZC 오퍼링·MSP 와 얼마나 맞물리나 — 모르면 비워두세요',                             12, options('sol-synergy')),
    ...
    ('서비스 급',        '[ISSU 분류] 모르면 비워두세요',                                            10, options('sol-grade')),
    ('규모급',           '[ISSU 분류] 모르면 비워두세요',                                            12, options('sol-scale')),
    ('포컬 담당',        '[ISSU 분류] MZC 내부 담당자. 모르면 비워두세요',                       14, None),
    ('운영 상태',        '[ISSU 분류] 지금 팔 수 있는 상태인가 — 모르면 비워두세요',                                      18, options('sol-status-op')),
...
BASIC += [('MZC 내부 의견', '[ISSU 분류] 전략·마진 코멘트. ⚠ 고객에게 노출되지 않습니다', 34, None)]

SECTIONS = [
    ('§1 솔루션 개요 / 핵심 차별점', '제공 형태·카테고리·JTBD 와 **차별적 비즈니스 가치**. '
     '여기 「① 라벨: 설명」 형식으로 쓴 것이 세일즈 피치의 강점 3줄로 그대로 나갑니다'),
    ('§1 내부 코멘트',              '[ISSU 분류] 🔒 고객 미노출. AI Tech 의견 등'),
    ...
    ('§8 내부 코멘트',              '[ISSU 분류] 🔒 고객 미노출. 마진·딜사이즈 전략'),
]

JUDGE = [
    ('역할 슬롯 *',   '[ISSU 분류] 「선택지」 시트의 슬롯 ID. **없으면 추천 후보가 되지 않습니다** — 모르면 비워두세요', 22, None),
    ('번들 확장성',   '[ISSU 분류] SI·MSP 와 얼마나 묶이나 — 모르면 비워두세요',                                                    24, options('sol-bundle-potential')),
]
...
SIMSHEET = [
    ('시뮬레이터 해당 옵션', '[ISSU 분류] 「선택지」 시트의 옵션 ID 를 쉼표로. 예) q1_3, q4_2 — 모르면 비워두세요', 60, None),
]
...
def build(out_path, rows):
    guide = [
        ...
        ['⑥ [ISSU 분류] 표시', '설명에 [ISSU 분류] 가 붙은 칸은 **우리 내부 분류 체계**입니다 '
                          '(4-Layer·역할 슬롯·급·시뮬레이터 매핑 등). 제품을 잘 아셔도 이 값은 모르는 게 정상이니 '
                          '비워두시면 ISSU 가 채웁니다. 나머지 칸이 조사해 주실 부분입니다.'],
        ['⑦ 평가영역 강도', '「3_판정데이터」의 A01~A10 은 **이 제품이 해결해 주는 영역**입니다. '
                          '아는 만큼 0~3 으로 적어주시면 ISSU 가 검토합니다. 열 설명에 각 영역의 주요 우려가 적혀 있습니다.'],
